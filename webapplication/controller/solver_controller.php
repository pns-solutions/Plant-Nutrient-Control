...
//$results = SensorMeasurement::find(); /*Wenn du find ohne eine Where clause aufrufst bekommst du aktuell noch alles was in der DB steht, das ändert sich aber noch!*/
